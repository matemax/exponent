...
\def\udk{512}
\ltitle{ Обобщенная сепаранта}
{М.\,А.~Лимонов\footnote[1]{%
{\it Лимонов Максим Амирьянович} --- аспирант
каф. высшая алгебра мех.-мат. ф-та МГУ,
e-mail: matemaks@ya.ru.}
}


\iabstract{ Пусть  $f\in K\{y\}$ многочлен в кольце  дифференциальных многочленов от одной дифференциальной переменной $y$ и одним дифференцированием $\delta$. Рассмотрим многочлен $g=\delta^n(f)$, тогда для любой переменной $y_k$ многочлен $g$  можно представить в виде $g=A_ky_k+g'$, где $g'$ не зависит от $y_k$. Если $y_k$ старшая переменная $g$, то $A_k$ является  сепаранта многочлена $f$. Для больших $n$ и $k$ мы нашли формулу для $A_k$ и показали использование её.
}
{%КЛЮЧЕВЫЕ СЛОВА НА РУССКОМ ЯЗЫКЕ:
Дифференциальный многочлен, сепаранта, обобщ\"eнная сепаранта
квазилинейный многочлен.}
{%АННОТАЦИЯ НА АНГЛИЙСКОМ ЯЗЫКЕ:
Let $f\in K\{y\}$ be a polynomial in a ring of differential polynomials with one differential variable $y$ and one differentiatial operator $\delta$. Let us consider $g=\delta^n(f)$. This polynomial can be represented in the following form $g=A_ky_k+g'$ for any variable $y_k$, where $g'$ does not depend on $y_k$. If $y_k$ has the highest order of variables of $g$, then $A_k$ is a separant of $g$. Thus we find a formula for $A_k$ that is correct for some large numbers $k$ and $n$. Also the author demonstrates some applications of this formula.}
{%КЛЮЧЕВЫЕ СЛОВА НА АНГЛИЙСКОМ ЯЗЫКЕ:
Differential polynomial, separant, generalized  separant, quasilinear polynomial.}

%------------------------------------------------------------------
Хорошо известно, что если $f$ дифференциальный многочлен,  то все его производные  линейны по старшей переменной (все определения смотри ниже). В частности, если у нас одна дифференциальная переменная и одно дифференцирование, то $n$-ую производную $f$ можно расписать следующим образом $f^{(n)}=S_fy_{n+l}+g$, где $l$~--- порядок многочлена $f$, $S_f$~--- сепаранта $f$, многочлен $g$  зависит от переменных, порядок которых меньше $n+l$.  Таким образом, у всех производных $f$ есть общая постоянная часть при старшей переменной. Появляется вопрос: а если рассмотреть не самую старшую переменную, а, например,  вторую по порядку переменную, будут ли они линейны и будет ли у них также выделится нечто постоянное?
...
В дальнейшем  мы будем считать, что поле ${K}$, над которым мы будем рассматривать многочлены,  будет алгеброй Ритта. Над этим полем зададим тождественно нулевое дифференцирование (см.~определение ниже).
...
Точно такое же условие возникает у Колчина в работе~\cite{E. R. Kolchin}. Но как алгоритмически проверять  это условие было непонятно. Но это уже отдельная тема. Колчин ввёл понятие экспоненты дифференциального идеала $I$ (наименьшее такое $m$, что  радикал  идеала $I$ в степени $m$ принадлежит $I$). Колчин рассматривал идеалы, порождённые одним многочленом $f$ первого порядка. Он всё разделил на два случая $[f,S_f]=(1)$ и $[f,S_f]\ne(1)$. В первом случае, Колчин доказал, что если $[f]+(S_f)=(1)$, то экспонента равна 1. 
