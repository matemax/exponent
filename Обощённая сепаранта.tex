...
Колчин вв\"ел вычислял в этой работе возможные значения \emph{экспоненты} дифференциального идеала $[f]$~--- наименьшего $m$, такого, что $\left(\sqrt{I}\right)^m \subset I$,
